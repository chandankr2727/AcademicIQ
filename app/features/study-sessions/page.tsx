        ...
        <section className="relative overflow-hidden pt-8 pb-16 lg:pt-12 lg:pb-24 bg-gradient-to-b from-[#f5f3ff] to-white">
          ...
          <div className="relative mx-auto max-w-[1280px] px-5 lg:px-10">
            ...
            <nav className="mb-8 flex items-center gap-2 text-[12px] font-semibold" aria-label="Breadcrumb">
              ...
              <span className="text-slate-500">Study Sessions</span>
            </nav>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:items-center">
              ...
              <div className="lg:col-span-5 flex flex-col">
                ...
                <p className="mt-3 text-[15px] sm:text-base font-medium leading-relaxed text-[#4b5a72]">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mt-8 pt-8 border-t border-slate-100">
                  ...
                  <div className="flex flex-col gap-2 text-left">
                    ...
                    <p className="text-[12px] font-extrabold text-[#0a1628] leading-tight">
                      Live & Interactive
                    </p>
                    <p className="text-[10.5px] font-semibold text-[#4b5a72] leading-snug">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 items-stretch">
              ...
              <div className="bg-white border border-[#e2e8f0] rounded-3xl p-6 shadow-xs flex flex-col justify-between hover:shadow-md transition-all duration-300">
                ...
                <div className="bg-white border border-[#e2e8f0] rounded-2xl p-4 mt-4 shadow-[0_2px_8px_rgba(0,0,0,0.02)] text-left">
                  <h4 className="text-[12px] font-bold text-[#0a1628] mb-3">Create a Study Session</h4>
                  <div className="space-y-2.5">
                    <div>
                      <label className="text-[9.5px] font-extrabold text-slate-400 uppercase tracking-wider block mb-1">Session Title</label>
                      <input
                        type="text"
                        value="Calculus Midterm Review"
                        readOnly
                        className="w-full bg-[#f8fafc] border border-slate-200 rounded-lg py-1.5 px-3 text-[11px] font-bold text-[#0a1628] outline-none"
                      />
                    </div>
                    <div>
                      <label className="text-[9.5px] font-extrabold text-slate-400 uppercase tracking-wider block mb-1">Date & Time</label>
                    ...
                    <button
                      type="button"
                      className="w-full bg-[#4f46e5] text-white text-[11px] font-black py-2 rounded-xl hover:opacity-90 shadow-xs transition-all cursor-pointer text-center mt-2"
                    >
                      Create Session
                    </button>
                  </div>
              ...
              <div className="bg-white border border-[#e2e8f0] rounded-3xl p-6 shadow-xs flex flex-col justify-between hover:shadow-md transition-all duration-300">
                ...
                <div className="bg-white border border-[#e2e8f0] rounded-2xl p-4 mt-4 shadow-[0_2px_8px_rgba(0,0,0,0.02)] text-left">
                  <h4 className="text-[11.5px] font-bold text-[#0a1628] mb-3">Invite Participants</h4>
                  <div className="space-y-2.5">
                    {/* Row 1 */}
                    <div className="flex items-center justify-between gap-2">
                      <div className="flex items-center gap-2">
                        <div className="h-6 w-6 rounded-full bg-[#e0e7ff] flex items-center justify-center text-[9px] font-black text-[#4f46e5] shrink-0">
                          MC
                        </div>
                        <span className="text-[11px] font-bold text-[#0a1628]">My Classmates</span>
                      </div>
                      <button className="bg-[#4f46e5] text-white text-[9.5px] font-bold px-2.5 py-1 rounded-lg hover:opacity-90 cursor-pointer">
                        Invite
                      </button>
                    </div>
                    {/* Row 2 */}
                    <div className="flex items-center justify-between gap-2">
                      <div className="flex items-center gap-2">
                        <div className="h-6 w-6 rounded-full bg-[#d1fae5] flex items-center justify-center text-[9px] font-black text-[#065f46] shrink-0">
                          IT
                        </div>
                        <span className="text-[11px] font-bold text-[#0a1628]">Instructors & Tutors</span>
                      </div>
                      <button className="bg-[#4f46e5] text-white text-[9.5px] font-bold px-2.5 py-1 rounded-lg hover:opacity-90 cursor-pointer">
                        Invite
                      </button>
                    ...
                    <div className="flex items-center justify-between gap-2">
                      <div className="flex items-center gap-2">
                        <div className="h-6 w-6 rounded-full bg-[#ffe4e6] flex items-center justify-center text-[9px] font-black text-[#be123c] shrink-0">
                          MN
                        </div>
                        <span className="text-[11px] font-bold text-[#0a1628]">My Network</span>
                      </div>
                      <button className="bg-[#4f46e5] text-white text-[9.5px] font-bold px-2.5 py-1 rounded-lg hover:opacity-90 cursor-pointer">
                        Invite
                      </button>
                    ...
                    <div className="flex items-center justify-between gap-2">
                      <div className="flex items-center gap-2">
                        <div className="h-6 w-6 rounded-full bg-[#fef3c7] flex items-center justify-center text-[9px] font-black text-[#92400e] shrink-0">
                          GC
                        </div>
                        <span className="text-[11px] font-bold text-[#0a1628]">Global Community</span>
                      </div>
                      <button className="bg-[#4f46e5] text-white text-[9.5px] font-bold px-2.5 py-1 rounded-lg hover:opacity-90 cursor-pointer">
                        Invite
                      </button>
            ...
            <div className="relative grid grid-cols-1 md:grid-cols-5 gap-8 text-center">
              ...
              <div className="relative flex flex-col items-center">
                <div className="flex h-14 w-14 items-center justify-center rounded-full bg-white border border-[#e2e8f0] shadow-sm text-indigo-600 mb-4 shrink-0 relative z-10">
                  ...
                  <span className="absolute -top-1.5 -right-1.5 bg-[#4f46e5] text-white font-black text-[10px] h-5 w-5 rounded-full flex items-center justify-center border border-white">
                    1
                  </span>
                </div>
              ...
              <div className="bg-white border border-[#e2e8f0] rounded-2xl overflow-hidden shadow-xs hover:shadow-md transition-shadow duration-300 flex flex-row">
                ...
                <div className="flex flex-col justify-center p-4 text-left flex-1">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <h3 className="text-[15px] font-bold text-[#0a1628]">For Students</h3>
                  </div>
                  <ul className="space-y-1">
                    <li className="flex items-center gap-2 text-[12px] font-semibold text-[#4b5a72]">
                      <span className="text-[#4f46e5] font-extrabold text-[13px] shrink-0">✓</span>
              ...
              <div className="bg-white border border-[#e2e8f0] rounded-2xl overflow-hidden shadow-xs hover:shadow-md transition-shadow duration-300 flex flex-row">
                ...
                <div className="flex flex-col justify-center p-4 text-left flex-1">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <h3 className="text-[15px] font-bold text-[#0a1628]">For Instructors</h3>
                  </div>
                  <ul className="space-y-1">
                    <li className="flex items-center gap-2 text-[12px] font-semibold text-[#4b5a72]">
                      <span className="text-[#4f46e5] font-extrabold text-[13px] shrink-0">✓</span>
              ...
              <div className="bg-white border border-[#e2e8f0] rounded-2xl overflow-hidden shadow-xs hover:shadow-md transition-shadow duration-300 flex flex-row">
                ...
                <div className="flex flex-col justify-center p-4 text-left flex-1">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <h3 className="text-[15px] font-bold text-[#0a1628]">For Institutions</h3>
                  </div>
                  <ul className="space-y-1">
                    <li className="flex items-center gap-2 text-[12px] font-semibold text-[#4b5a72]">
                      <span className="text-[#4f46e5] font-extrabold text-[13px] shrink-0">✓</span>
              ...
              <div className="bg-white border border-[#e2e8f0] rounded-2xl overflow-hidden shadow-xs hover:shadow-md transition-shadow duration-300 flex flex-row">
                ...
                <div className="flex flex-col justify-center p-4 text-left flex-1">
                  <div className="flex items-center gap-2 mb-3">
                    ...
                    <h3 className="text-[15px] font-bold text-[#0a1628]">For Communities</h3>
                  </div>
                  <ul className="space-y-1">
                    <li className="flex items-center gap-2 text-[12px] font-semibold text-[#4b5a72]">
                      <span className="text-[#4f46e5] font-extrabold text-[13px] shrink-0">✓</span>
