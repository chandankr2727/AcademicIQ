              ...
              <div className="lg:col-span-5 flex flex-col">
                ...
                <div className="grid grid-cols-3 gap-4 mt-8 pt-8 border-t border-slate-100">
                  ...
                  <div className="flex flex-col gap-2 text-left">
                    ...
                    <p className="text-[11px] font-medium text-[#4b5a72] leading-snug">
                ...
                <div className="bg-white border border-[#e2e8f0] rounded-2xl p-4 space-y-3.5 mt-4 text-left shadow-[0_2px_8px_rgba(0,0,0,0.02)]">
                  ...
                  <div className="flex items-center justify-between gap-2">
                    <div className="flex items-center gap-2.5 min-w-0">
                      ...
                      <span className="text-[11.5px] font-bold text-[#0a1628] truncate">What is implicit differentiation?</span>
                    </div>
                  ...
                  <div className="flex items-center justify-between gap-2">
                    <div className="flex items-center gap-2.5 min-w-0">
                      ...
                      <span className="text-[11.5px] font-bold text-[#0a1628] truncate">Chapter 4 Homework Help</span>
                    </div>
                  ...
                  <div className="flex items-center justify-between gap-2">
                    <div className="flex items-center gap-2.5 min-w-0">
                      ...
                      <span className="text-[11.5px] font-bold text-[#0a1628] truncate">Exam Review Questions</span>
                    </div>
                    <span className="text-[10px] font-semibold text-slate-400 shrink-0">15 replies</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white border border-[#e2e8f0] rounded-3xl p-6 shadow-xs flex flex-col justify-between hover:shadow-md transition-shadow duration-300">
                ...
                <div className="bg-white border border-[#e2e8f0] rounded-2xl p-4 text-left mt-4 shadow-[0_2px_8px_rgba(0,0,0,0.02)] space-y-3">
                  <div className="flex items-center gap-2 justify-between">
                    ...
                    <span className="text-[10px] font-extrabold bg-[#f3e8ff] text-purple-600 px-2 py-0.5 rounded-md shrink-0">+7</span>
                  </div>

                  <div className="bg-[#f8fafc] border border-[#f1f5f9] rounded-xl p-2.5">
                    <p className="text-[11px] font-semibold text-[#4b5a72] leading-normal">
                ...
                <div className="bg-white border border-[#e2e8f0] rounded-2xl p-4 space-y-3 mt-4 text-left shadow-[0_2px_8px_rgba(0,0,0,0.02)]">
                  ...
                  <div className="flex items-center gap-2.5">
                    ...
                    <div className="flex flex-col truncate">
                      <span className="text-[11px] font-bold text-[#0a1628] leading-none truncate">Study Guide.pdf</span>
                      <span className="text-[9px] font-semibold text-slate-400 mt-0.5">PDF • 1.2 MB</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2.5">
                    ...
                    <div className="flex flex-col truncate">
                      <span className="text-[11px] font-bold text-[#0a1628] leading-none truncate">Lecture Recording.mp4</span>
                      <span className="text-[9px] font-semibold text-slate-400 mt-0.5">MP4 • 45:12</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-2.5">
                    ...
                    <div className="flex flex-col truncate">
                      <span className="text-[11px] font-bold text-[#0a1628] leading-none truncate">Problem Set 3.docx</span>
                      <span className="text-[9px] font-semibold text-slate-400 mt-0.5">DOCX • 1.1 MB</span>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="bg-white border border-[#e2e8f0] rounded-2xl p-3 text-left mt-4 shadow-[0_2px_8px_rgba(0,0,0,0.02)] space-y-2">
                  <div className="relative">
                    <input
                      ...
                      disabled
                      className="w-full bg-[#f8fafc] border border-slate-200 rounded-lg py-1 pl-7 pr-2 text-[10px] text-slate-700 outline-none"
                    />
                    <MagnifyingGlass size={11} className="absolute left-2.5 top-1/2 -translate-y-1/2 text-slate-400" />
                  </div>

                  <span className="text-[8.5px] font-extrabold text-slate-400 uppercase tracking-wider block">From last week</span>

                  <div className="flex gap-2 items-start bg-slate-50/50 p-1.5 rounded-lg border border-slate-100">
                    <div className="h-5.5 w-5.5 rounded-full bg-blue-100 flex items-center justify-center text-[8px] font-bold text-blue-600 shrink-0">
                      DW
                    </div>
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center justify-between gap-2">
                        <span className="text-[9.5px] font-bold text-[#0a1628] truncate">Dr. Williams</span>
                        <span className="text-[8.5px] font-semibold text-slate-400 shrink-0">May 6</span>
                      </div>
                      <p className="text-[9.5px] font-medium text-[#4b5a72] leading-normal truncate">
                        Great explanation!
                      </p>
                    </div>
                  </div>
                ...
                <div className="flex flex-col justify-center p-5 text-left flex-1">
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-center gap-2 text-[12.5px] font-semibold text-[#4b5a72]">
                      <span className="text-purple-600 font-extrabold text-[14px] shrink-0">✓</span>
                      Ask questions
                    </li>
                    <li className="flex items-center gap-2 text-[12.5px] font-semibold text-[#4b5a72]">
                      <span className="text-purple-600 font-extrabold text-[14px] shrink-0">✓</span>
